...
macro(check_msvc_arch)
    ...
    elseif(MSVC_VERSION EQUAL 1900 OR MSVC_TOOLSET_VERSION EQUAL 140)
        if(CMAKE_CL_64)
            set(MSVC_ARCH "x64Win64VS2015")
        else()
            set(MSVC_ARCH "i86Win32VS2015")
        endif()
    elseif((MSVC_VERSION GREATER 1910 AND MSVC_VERSION LESS 1919) OR (MSVC_TOOLSET_VERSION EQUAL 141))
        if(CMAKE_CL_64)
            set(MSVC_ARCH "x64Win64VS2017")
        else()
            set(MSVC_ARCH "i86Win32VS2017")
        endif()
    elseif((MSVC_VERSION GREATER 1920 AND MSVC_VERSION LESS 1929) OR (MSVC_TOOLSET_VERSION EQUAL 142))
        if(CMAKE_CL_64)
            set(MSVC_ARCH "x64Win64VS2019")
        else()
            set(MSVC_ARCH "i86Win32VS2019")
        endif()
    else()
        if(CMAKE_CL_64)
