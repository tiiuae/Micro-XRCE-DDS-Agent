...
FROM --platform=${BUILDPLATFORM:-linux/amd64} ghcr.io/tiiuae/fog-ros-sdk:sha-6d6db6d-${TARGETARCH:-amd64} AS builder
...
FROM ghcr.io/tiiuae/fog-ros-baseimage:sha-6d6db6d
